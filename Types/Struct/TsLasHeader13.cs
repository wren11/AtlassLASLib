...
{
    /// <summary>
    /// Las 1.3 header with wave information.
    ...
    public struct TsLasHeader13 : TiLasHeader
    {
        ...
        public UInt16 GetPointSize()
        {
            ...
            {
                case 4:
                    return (UInt16)Marshal.SizeOf(typeof(TsLasPoint4));

                case 5:
                    return (UInt16)Marshal.SizeOf(typeof(TsLasPoint5));
